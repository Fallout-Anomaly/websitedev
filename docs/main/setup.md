---
sidebar_position: 3
title: Wabbajack Download & Install
hide_title: true
sidebar_label: Wabbajack Download & Install
---
import TerminalCard from '@site/src/components/TerminalCard';

# Wabbajack Download & Install
...
<div style={{marginBottom: '2rem'}}>
<TerminalCard title="Step 1 - Wabbajack prerequisites">

### Log into Nexus in Wabbajack

Open Wabbajack, click the Settings (gear) icon, and log in under the Nexus panel. This is **mandatory** for the automatic download system to work. 
...
Congratulations! Before you play, go to the **Launching** section to learn how to start the game and configure settings.
